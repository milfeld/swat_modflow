...
FFLAG=-c -standard-semantics -fmessage-length=0 -ffixed-line-length-80  -funderscoring -fbacktrace -ffpe-trap=invalid,zero,overflow -diag-disable 8291
RFLAG=-O3
...
$(PROJ_NAME): $(S_OBJ)
	...
	${FC} ${ARCH64} -diag-disable 8291 -fopenmp -mkl $^ -o $@ 
