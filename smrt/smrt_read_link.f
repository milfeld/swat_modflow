...
!     Import variables
      ...
      open(6001,file=data_swatmf//'swatmf_link.txt')
      read(6001,*) mf_active
      ...
      if(mf_active.eq.1) then
        open(6008,file=data_out//'swatmf_log')
      ...
      if(out_SWAT_recharge.eq.1) then
        open(30001,file=data_out//'swatmf_out_SWAT_recharge') !rtb
      ...
      if(out_MF_recharge.eq.1) then
        open(30002,file=data_out//'swatmf_out_MF_recharge') !rtb
      ...
      if(out_SWAT_channel.eq.1) then
        open(30003,file=data_out//'swatmf_out_SWAT_channel') !rtb
      ...
      if(out_MF_channel.eq.1) then
        open(30004,file=data_out//'swatmf_out_MF_riverstage') !rtb
      ...
      if(out_MODFLOW_gwsw.eq.1) then
        open(30005,file=data_out//'swatmf_out_MF_gwsw') !rtb
      ...
      if(out_SWAT_gwsw.eq.1) then
        open(30006,file=data_out//'swatmf_out_SWAT_gwsw') !rtb
      ...
      open(30007,file=data_out//'swatmf_out_RT_rivno3') !rtb
      ...
      open(30008,file=data_out//'swatmf_out_SWAT_rivno3') !rtb
      ...
      open(30009,file=data_out//'swatmf_out_RT_rechno3') !rtb
      ...
      open(30010,file=data_out//'swatmf_out_SWAT_rechno3') !rtb
      write(30010,*) 'SWAT NO3-N Recharge Conc. (mg/L)'

      !GW/SW P exchange (by MODFLOW River Cell) ----------------------------------------- PHOSPHORUS
      open(30011,file=data_out//'swatmf_out_RT_rivP') !rtb
      ...
      open(30012,file=data_out//'swatmf_out_SWAT_rivP') !rtb
      ...
      open(30013,file=data_out//'swatmf_out_RT_rechP') !rtb
      ...
      open(30014,file=data_out//'swatmf_out_SWAT_rechP') !rtb
